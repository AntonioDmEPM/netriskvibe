...
const flows = [
  { id: "returning", label: "Flow 1: Visszatérő ügyfél", color: "bg-blue-600 hover:bg-blue-700" },
  { id: "new", label: "Flow 2: Új ügyfél", color: "bg-emerald-600 hover:bg-emerald-700" },
  { id: "advisory", label: "Flow 3: Tanácsadás", color: "bg-purple-600 hover:bg-purple-700" },
];
