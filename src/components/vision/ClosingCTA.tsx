    ...
    >
      <div className="max-w-3xl mx-auto text-center">
        <ScrollReveal>
          ...
          >
            {lang === "hu"
              ? "\"A jelenlegi modell 15 000 Ft-ot keres, amikor egy ügyfél kattint. Mi lenne, ha 75 000–150 000 Ft-ot keresne évente az ügyfél pénzügyi életének kezelésével?\""
        ...
        <ScrollReveal delay={120}>
          <p className="text-lg text-gray-400 mb-4 leading-relaxed">
            {lang === "hu"
              ? "Az első vállalat, amely megbízható pénzügyi ágenst épít, az ügyfélkapcsolat tulajdonosa lesz."
              : "The first company to build a trusted financial agent will own the consumer relationship."}
          </p>
          <p className="text-base text-gray-500 mb-10">
            {lang === "hu"
              ? "Az összehasonlító oldalak a háttérinfrastruktúrává válnak."
          ...
          <ScrollReveal delay={300}>
            <div className="mb-16">
              <p className="text-sm text-gray-400 mb-4">
                {lang === "hu" ? "Próbálja ki a demókat:" : "Try the demos:"}
              </p>
              <div className="flex flex-col sm:flex-row gap-3 justify-center">
                ...
                >
                  {lang === "hu" ? "Netrisk AI Tanácsadó →" : "Netrisk AI Advisor →"}
                </Button>
                <Button
                  variant="outline"
                  className="border-white/20 text-white bg-white/5 hover:bg-white/10 hover:text-white"
                ...
                >
                  {lang === "hu" ? "Személyes pénzügyi irányítópult →" : "Personal Finance Dashboard →"}
                </Button>
              </div>
            </div>
          </ScrollReveal>
        ...
        <ScrollReveal delay={400}>
          <div className="space-y-2">
            <p className="text-sm text-gray-500">
              {lang === "hu" ? "Készítette: " : "Built by "}
              <span className="text-gray-300 font-semibold">EPAM Applied AI</span>
            </p>
