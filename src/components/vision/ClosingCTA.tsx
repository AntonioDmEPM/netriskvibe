    ...
    >
      <div className="max-w-3xl mx-auto text-center">
        <ScrollReveal>
          ...
          >
            "Your current model earns €38 when a customer clicks. What if you earned €188–€375/year by managing that customer's financial life?"
          </p>
        </ScrollReveal>
        ...
        <ScrollReveal delay={400}>
          <div className="space-y-2">
            <p className="text-sm text-gray-500">
              Built by <span className="text-gray-300 font-semibold">EPAM Applied AI</span>
            </p>
